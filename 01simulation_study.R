...
plot(return_periods, gev_return_levels, type = "b", pch = 19, xlab = "Return Period (years)", ylab = "Return Level (deg C)", main = "Return Level Plot", col = "blue")
...
# plot return levels
plot(return_periods, gev_return_levels, type = "b", pch = 19, xlab = "Return Period (years)", ylab = "Return Level (deg C)", main = "Return Level Plot", col = "blue", ylim = range(c(gev_return_levels, true_return_levels)))
lines(return_periods, gev_return_levels, col = "blue", lwd = 2)
